...
#if defined(CONFIG_ENCORE_MPU_ENABLE_1100MHZ) | defined(CONFIG_ENCORE_MPU_ENABLE_1200MHZ)
...
#elif !defined(CONFIG_ENCORE_MPU_DISABLE_1000MHZ)
...
#if defined(CONFIG_ENCORE_MPU_ENABLE_1100MHZ)
#define ENCORE_MPU_OPP5_FREQ 1100000000
#elif defined(CONFIG_ENCORE_MPU_ENABLE_1200MHZ)
...
#if defined(CONFIG_ENCORE_L3_UNDERCLOCK)
	/* L3 OPP1 - OPP50 */
...
#endif
#ifndef CONFIG_ENCORE_MPU_DISABLE_1000MHZ
